  ...
  Form.editors.List = Form.editors.Base.extend({
    ...
    template: _.template('\
      <div >\
        <ul data-role="listview" data-split-icon="delete" data-split-theme="a" data-inset="true" data-items></ul>\
  ...
  Form.editors.List.Modal = Form.editors.Base.extend({
    ...
    itemToString: function(value) {
      ...
      // logg
       remove_button = "<a data-action='remove'>Usuń Plik</a>";
parts.forEach(function(part, i){ return parts[i] = "" + part+ "" })
//console.log(parts);

parts.unshift("<img src='img/aa.png'>");
