  ...
  (function() {
    (function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        __out.push('</td>\n         <td>');
        __out.push(__sanitize(item['client_type']));
        __out.push('</td>\n         <td>');
        __out.push(__sanitize(item['date']));
        __out.push('</td>\n       </tr>\n      ');
      }
